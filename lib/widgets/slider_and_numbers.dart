...
class SliderAndNumbers extends StatefulWidget {
  final double width;
  final double height;
  final PickerCallback onColorUpdate;
  final SliderCallback onNumberUpdate;

  const SliderAndNumbers(
      {Key key, this.width, this.height, this.onColorUpdate, this.onNumberUpdate})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _SliderAndNumbersState();
  }
}

class _SliderAndNumbersState extends State<SliderAndNumbers> {
  Circle _slider;
  Circle _picker;
    ...
    return Positioned(
      ...
      child: Container(
        ...
        child: GestureDetector(
          ...
          child: CustomPaint(
            painter: SliderAndNumbersPainter(
              slider: _slider,
              picker: _picker,
              color: _color,
...
class SliderAndNumbersPainter extends CustomPainter {
  ...
  SliderAndNumbersPainter({@required this.slider, @required this.picker, @required this.color, @required this.angleSlider, @required this.anglePicker, });
